...
struct SnapshotTests {
    ...
    func simpleStruct() throws {
        try assertSnapshot(
            for: "SimpleStruct.txt", fixturesDirectory: fixturesDirectory, expectedDirectory: expectedDirectory)
    }
    ...
    func classWithProperties() throws {
        try assertSnapshot(
            for: "ClassWithProperties.txt", fixturesDirectory: fixturesDirectory, expectedDirectory: expectedDirectory)
    }
    ...
    func multipleTypes() throws {
        try assertSnapshot(
            for: "MultipleTypes.txt", fixturesDirectory: fixturesDirectory, expectedDirectory: expectedDirectory)
    }
    ...
    func nestedTypes() throws {
        try assertSnapshot(
            for: "NestedTypes.txt", fixturesDirectory: fixturesDirectory, expectedDirectory: expectedDirectory)
    }
    ...
    func commentsPreserved() throws {
        try assertSnapshot(
            for: "CommentsPreserved.txt", fixturesDirectory: fixturesDirectory, expectedDirectory: expectedDirectory)
    }
    ...
    func alreadyOrdered() throws {
        try assertSnapshot(
            for: "AlreadyOrdered.txt", fixturesDirectory: fixturesDirectory, expectedDirectory: expectedDirectory)
    }
    ...
    func annotatedMembers() throws {
        try assertSnapshot(
            for: "AnnotatedMembers.txt", fixturesDirectory: fixturesDirectory, expectedDirectory: expectedDirectory)
    }
    ...
    func visibilityOrdering() throws {
        try assertSnapshot(
            for: "VisibilityOrdering.txt", fixturesDirectory: fixturesDirectory, expectedDirectory: expectedDirectory)
    }
    ...
    func typeWithExtension() throws {
        try assertSnapshot(
            for: "TypeWithExtension.txt", fixturesDirectory: fixturesDirectory, expectedDirectory: expectedDirectory)
    }
    ...
    func annotatedWithVisibility() throws {
        try assertSnapshot(
            for: "AnnotatedWithVisibility.txt", fixturesDirectory: fixturesDirectory,
    ...
    func nestedTypesWithExtension() throws {
        try assertSnapshot(
            for: "NestedTypesWithExtension.txt", fixturesDirectory: fixturesDirectory,
            expectedDirectory: expectedDirectory)
    }
}
