...
struct ConfigurationLoader {
    ...
    func parse(_ content: String) throws -> RawConfiguration {
        ...
        while index < lines.count {
            ...
            if trimmed.hasPrefix("version:") {
                ...
                index += 1
                index = parsePaths(lines: lines, from: index, into: &paths)
            } else {
                index += 1
            }
        }
    ...
    private func parsePaths(lines: [String], from startIndex: Int, into paths: inout [String]) -> Int {
        var index = startIndex
        var listIndent: Int?
        ...
        while index < lines.count {
            ...
            paths.append(String(trimmed.dropFirst(2)))
            index += 1
        }
