...
Swift Marshal is currently under active development.
...
If you discover a security vulnerability in Swift Marshal, please **do not open a public issue**.
...
- The Swift Marshal CLI (`swift-marshal`)
- The Swift Marshal Build Tool Plugin
- Distribution artifacts
- Configuration handling (`.swift-marshal.yaml`)
...
Thank you for helping keep Swift Marshal secure.
